        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
            ...
            >
              <div>
                <div className="mb-8 flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-semibold  text-colorPurpleBlue">Licensing Exam Experts</p>
                  </div>
                </div>
              ...
              <div className="mt-8 flex items-center divide-x divide-gray-200 rounded-xl bg-gray-50 py-4">
                <div className="flex-1 px-4 text-center">
                  <div className="font-title text-3xl font-bold text-colorPurpleBlue">97%</div>
                  <div className="text-sm font-medium text-gray-500">Pass Rate</div>
                </div>
                <div className="flex-1 px-4 text-center">
                  <div className="font-title text-3xl font-bold text-colorPurpleBlue">10+</div>
                  <div className="text-sm font-medium text-gray-500">Years Experience</div>
                </div>
              </div>
            </div>
